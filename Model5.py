...
def get_model(input_shape, pool_size=(2, 2, 2), n_labels=1, initial_learning_rate=0.0001, deconvolution=False, downsize_filters_factor=4):
    """
    ...
    conv4 = Conv3D(int(256 / downsize_filters_factor), (3, 3, 3), activation='relu', padding='same')(pool2)
    ...
    up6 = get_upconv(pool_size=pool_size, deconvolution=deconvolution, depth=1,
                     nb_filters=int(256 / downsize_filters_factor), image_shape=input_shape[-3:])(conv4)
