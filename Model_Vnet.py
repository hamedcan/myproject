...
def get_model(logger, log_disable ,input_shape, pool_size=(2, 2, 2), filter_size=(3, 3, 3), n_labels=1, deconvolution=True, drop_rate=0.0):
    ...
    pool1 = Conv3D(32, filter_size,stride=(2,2,2), padding='same', activation='relu')(conv1)
    ...
    pool2 = Conv3D(64, filter_size,stride=(2,2,2), padding='same', activation='relu')(conv2)
    ...
    pool3 = Conv3D(128, filter_size,stride=(2,2,2), padding='same', activation='relu')(conv3)
    ...
    up5 = Deconv3D(128,filter_size,stride=(2,2,2),padding='same',activation='relu')(conv4)
    ...
    up6 = Deconv3D(64,filter_size,stride=(2,2,2),padding='same',activation='relu')(conv5)
    ...
    up7 = Deconv3D(32, filter_size, stride=(2, 2, 2), padding='same', activation='relu')(conv6)
