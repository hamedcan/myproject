...
def get_model(input_shape, pool_size=(2, 2, 2), n_labels=1, initial_learning_rate=0.00001, deconvolution=False, downsize_filters_factor=1):
    ...
    conv1 = Conv3D(int(32 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(inputs)
    conv1 = Conv3D(int(64 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv1)
    pool1 = MaxPooling3D(pool_size=pool_size, strides=2)(conv1)

    conv2 = Conv3D(int(64 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(pool1)
    conv2 = Conv3D(int(128 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv2)
    pool2 = MaxPooling3D(pool_size=pool_size, strides=2)(conv2)

    conv3 = Conv3D(int(128 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(pool2)
    conv3 = Conv3D(int(256 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv3)
    pool3 = MaxPooling3D(pool_size=pool_size, strides=2)(conv3)

    conv4 = Conv3D(int(256 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(pool3)
    conv4 = Conv3D(int(512 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv4)
    ...
    conv5 = Conv3D(int(256 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(up5)
    conv5 = Conv3D(int(256 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv5)
    ...
    conv6 = Conv3D(int(128 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(up6)
    conv6 = Conv3D(int(128 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv6)
    ...
    conv7 = Conv3D(int(64 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(up7)
    conv7 = Conv3D(int(64 / downsize_filters_factor), (5, 5, 5), activation='relu', padding='same', kernel_initializer=initer)(conv7)
...
def get_upconv(depth, nb_filters, pool_size, image_shape, kernel_size=(2, 2, 2), strides=(2, 2, 2),
    ...
    if deconvolution:
        try:
            ...
            raise ImportError(
                "Install keras_contrib in order to use deconvolution. Otherwise set deconvolution=False.")
