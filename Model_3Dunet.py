...
def get_model(logger, log_disable, input_shape, pool_size=(2, 2, 2), filter_size=(3, 3, 3), n_labels=1):
    ...
    up5 = Conv3D(512, (2,2,2), padding='same', activation='relu')(up5)
    ...
    up6 = Conv3D(256, (2,2,2), padding='same', activation='relu')(up6)
    ...
    up7 = Conv3D(128, (2,2,2), padding='same', activation='relu')(up7)
