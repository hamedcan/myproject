...
def get_model(logger, log_disable ,input_shape, pool_size=(2, 2, 2), filter_size=(3, 3, 3), n_labels=1):
    ...
    up5 = Deconv3D(64,filter_size, strides=(2,2,2), padding='same',activation='relu')(conv4)
    ...
    up6 = Deconv3D(32,filter_size, strides=(2,2,2), padding='same',activation='relu')(conv5)
    ...
    up7 = Deconv3D(16, filter_size, strides=(2,2,2), padding='same', activation='relu')(conv6)
